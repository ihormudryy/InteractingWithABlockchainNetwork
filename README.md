...
**Invoke Operation** (This will create a user with 500 ${COIN_NAME}s)
```
type = invoke
...
From this you will see a return message: (500 ${COIN_NAME}s were created)

```
{"message":"success","result":{"txId":"82700302bd916df4aecc9685150d0e5e9ba8a385407fbd1d80b7f03c5c474255","results":{"status":200,"message":"","payload":"{\"id\":\"e0165a07-9358-470e-b29d-9412b7967000\",\"memberType\":\"user\",\"${COIN_NAME}sBalance\":5,\"totalSteps\":500,\"stepsUsedForConversion\":500,\"contractIds\":null,\"generatedFitcoins\":5}"}}}
```

**Invoke Operation** (Alternative way to generate 500 ${COIN_NAME}s)
```
type = invoke
userId = e0165a07-9358-470e-b29d-9412b7967000
...
From this you will see a return message: (It shows that this userid has 500 ${COIN_NAME}s)
```
{"message":"success","result":"{\"contractIds\":null,\"${COIN_NAME}sBalance\":5,\"id\":\"e0165a07-9358-470e-b29d-9412b7967000\",\"memberType\":\"user\",\"stepsUsedForConversion\":500,\"totalSteps\":500}"}
```
