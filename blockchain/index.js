...
var host = process.env.HOST || hfc.getConfigSetting('host') || "localhost";
var port = process.env.PORT || hfc.getConfigSetting('port') || "4000";
///////////////////////////////////////////////////////////////////////////////
//////////////////////////////// SET CONFIGURATONS ////////////////////////////
///////////////////////////////////////////////////////////////////////////////
app.options('*', cors());
...
app.post('/users', async function(req, res) {
	...
	logger.debug(hfc.getConfigSetting('jwt_expiretime'));
	var token = jwt.sign({
...
app.post('/channels', async function(req, res) {
	...
	let message = await channel.createChannel(channelName, channelConfigPath, req.username, req.orgname);
	res.send(message);
});
// Join Channel
app.post('/channels/:channelName/peers', async function(req, res) {
	...
	let message =  await channel.joinChannel(channelName, peers, req.username, req.orgname);
	res.send(message);
});
// Update anchor peers
...
app.post('/chaincodes', async function(req, res) {
	...
	let message = await chaincode.installChaincode(peers, chaincodeName, chaincodePath, chaincodeVersion, chaincodeType, req.username, req.orgname)
	res.send(message);});
...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	let message = await chaincode.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, args, req.username, req.orgname);
	res.send(message);
});
